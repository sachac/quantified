class Ability
  ...
  def initialize(user)
    ...
    if user.role == 'admin'
      ...
      [Clothing, ClothingLog, Context, ClothingMatch, CsaFood, DecisionLog, Decision, Food, LibraryItem, LocationHistory, MeasurementLog, Measurement, Stuff, TimeRecord, TorontoLibrary, Memory, TapLogRecord, RecordCategory, Goal, ReceiptItem].each do |item|
