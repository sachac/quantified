class Ability
  ...
  def initialize(user)
    ...
    if user.role == 'admin'
      ...
      [Clothing, ClothingLog, ClothingMatch, CsaFood, Day, DecisionLog, Decision, Food, LibraryItem, LocationHistory, Location, MeasurementLog, Measurement, Stuff, TimeRecord, TorontoLibrary, Context, Memory].each do |item|
